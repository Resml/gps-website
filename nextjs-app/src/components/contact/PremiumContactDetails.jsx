        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
              ...
              <a href="tel:+918484898144" className="reveal delay-2" style={{
              ...
              <a href="tel:+919764252188" className="reveal delay-3" style={{
                background: '#fff', borderRadius: '20px', padding: '24px', border: '1px solid var(--border)', transition: 'all 0.3s ease', display: 'block'
              }} onMouseEnter={e => e.currentTarget.style.transform = 'translateY(-4px)'} onMouseLeave={e => e.currentTarget.style.transform = 'translateY(0)'}>
            ...
            <div className="reveal delay-4" style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              <a href="mailto:response@gpsspindles.net" className="btn btn-outline" style={{ flex: '1 1 auto', justifyContent: 'center', background: '#fff' }}>
