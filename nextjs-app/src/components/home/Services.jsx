    ...
    <section className="section">
      <div className="container">
        ...
        <div className="services-grid">
          ...
          <div className="service-card reveal delay-1">
            <div className="service-card-img">
              <img src="/images/spindle-accessories-2.webp" alt="Spindle Accessories" />
              <div className="service-card-img-overlay"></div>
            </div>
            <div className="service-card-body">
              <div className="service-card-icon">
          ...
          <div className="service-card service-emergency reveal delay-3">
            ...
            <a href="https://wa.me/918484898144?text=Emergency!%20My%20spindle%20is%20down%20and%20I%20need%20urgent%20help." className="btn btn-wa" target="_blank" rel="noopener noreferrer">
