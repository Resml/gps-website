    ...
    <section className="cta-dark">
      <div className="container">
        <div className="reveal">
          ...
          <div className="btns">
            <a href="https://wa.me/919764032929?text=Hi%20GPS%20Spindles%2C%20I%20need%20spindle%20help.%20Please%20call%20me."
            ...
            <Link href="/gps-contact" className="btn btn-dark">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="cta-trust-note">
            ...
            15-min response on WhatsApp · No spam · 100% free assessment
          </div>
        </div>
      </div>
    </section>
