        ...
        <div className="container">
          <div className="footer-grid">
            ...
            <div className="footer-brand">
              ...
              <p>General Precision Spindles (GPS) — Pune's most trusted CNC, VMC &amp; HMC spindle repair and reconditioning specialists since 2017. Serving 900+ clients with documented quality and 1-year warranty.</p>
              <div className="footer-social">
                ...
                {/* WhatsApp */}
                <a href="https://wa.me/918484898144" target="_blank" rel="noopener" aria-label="WhatsApp">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="footer-contact">
                ...
                <li>
                  ...
                  <p><a href="tel:+918484898144">+91 8484898144</a> (Sachin)<br /><a href="tel:+919764252188">+91 97642 52188</a> (Anil)</p>
                </li>
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <p><a href="mailto:response@gpsspindles.net">response@gpsspindles.net</a></p>
                </li>
              </ul>
