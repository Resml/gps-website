...
const whyUs = [
  { title: 'Decades of Experience', desc: 'Extensive background in the design and manufacturing of custom spindles.' },
  { title: 'Advanced Tools', desc: 'Equipped with the latest, state-of-the-art tools for precise manufacturing.' },
  { title: 'Cost-Effective', desc: 'Affordable options for both new custom manufacturing and spindle repairs.' },
  { title: 'Efficient Processes', desc: 'Streamlined workflows designed to minimize downtime for your operations.' },
  { title: 'Precision Engineering', desc: 'High-quality spindles built to exact tolerances for superior performance.' },
  { title: 'Reliable Support', desc: 'Comprehensive delivery, deployment, and continued maintenance support.' },
];
      ...
      <section style={{ background: 'var(--white)', padding: '90px 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: '56px' }}>
            <span style={{ display: 'inline-block', background: 'rgba(234, 88, 12, 0.08)', border: '1px solid rgba(234, 88, 12, 0.15)', color: 'var(--orange)', fontSize: '12px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', padding: '6px 16px', borderRadius: '50px', marginBottom: '16px' }}>Manufacturing Process</span>
            <h2 style={{ color: 'var(--navy)', marginBottom: '12px' }}>How We Build <span style={{ color: 'var(--orange)' }}>Your Spindles</span></h2>
            <p style={{ color: 'var(--muted)', maxWidth: '560px', margin: '0 auto' }}>A meticulous 4-step workflow designed to deliver unparalleled precision and durability for your unique applications.</p>
          </div>
            ...
            <div className="reveal delay-2">
              <div className="srv-industries-box">
                ...
                <div className="srv-cta-box">
                  ...
                  <a href="https://wa.me/919764032929?text=Hi%20GPS%20Spindles!%20I%20need%20a%20consultation%20for%20Customized%20Spindles." target="_blank" rel="noopener noreferrer" className="btn btn-wa" style={{ marginTop: '12px', width: '100%', justifyContent: 'center', gap: '8px' }}>
