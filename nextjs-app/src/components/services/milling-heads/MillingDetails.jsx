...
const whyUs = [
  { title: 'Highly Skilled Technicians', desc: 'Experienced professionals with deep expertise in milling machine mechanics and restorations.' },
  { title: 'State-of-the-Art Facilities', desc: 'Equipped with ultra-precision machinery for comprehensive testing, grinding, and repair.' },
  { title: 'OEM Standards', desc: 'All repairs and replacements are conducted to strictly meet or exceed original equipment specifications.' },
  { title: 'Rapid Turnaround', desc: 'Streamlined repair processes ensuring your milling heads are back in production with minimal downtime.' },
  { title: 'Quality Guarantee', desc: 'Backed by a 1-year warranty on all our milling head reconditioning services.' },
  { title: 'Performance Boost', desc: 'Restoring optimal torque and precision to enhance your overall machining efficiency.' },
];
      ...
      <section style={{ background: 'var(--white)', padding: '90px 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="reveal" style={{ textAlign: 'center', marginBottom: '56px' }}>
            <span style={{ display: 'inline-block', background: 'rgba(234, 88, 12, 0.08)', border: '1px solid rgba(234, 88, 12, 0.15)', color: 'var(--orange)', fontSize: '12px', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', padding: '6px 16px', borderRadius: '50px', marginBottom: '16px' }}>Meticulous Rebuilding</span>
            <h2 style={{ color: 'var(--navy)', marginBottom: '12px' }}>Our Restoration <span style={{ color: 'var(--orange)' }}>Process</span></h2>
            <p style={{ color: 'var(--muted)', maxWidth: '560px', margin: '0 auto' }}>A structured, rigorous 4-step workflow designed to restore absolute precision and torque to worn milling heads.</p>
          </div>
            ...
            <div className="reveal delay-2">
              <div className="srv-industries-box">
                ...
                <div className="srv-cta-box">
                  ...
                  <a href="https://wa.me/919764032929?text=Hi%20GPS%20Spindles!%20I%20need%20Milling%20Head%20Repair%20Services." target="_blank" rel="noopener noreferrer" className="btn btn-wa" style={{ marginTop: '12px', width: '100%', textAlign: 'center', justifyContent: 'center', gap: '8px' }}>
